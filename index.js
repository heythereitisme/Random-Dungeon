...
let theGame = async () => {
  ...
  gameLoop: for (let i = 1; i < 6; i++) {
    ...
    if (i === 5) {
      console.log("\x1b[31mfinal boss\nYou hear growling ahead, you look ahead and see a giant ogre! He appears to be guarding the ultimate treasure!\x1b[0m");
      await slowDown(5000)
      let finalBattle = await battleTime(20)
      if(finalBattle === true) {
        console.log("\x1b[33mAfter defeating the Ogre you come across a huge treasure chest, when you get home you will live like a king!\x1b[0m")
        await slowDown(3000)
